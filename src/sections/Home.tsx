    ...
    return (
        <>
            <section ref={RefProp} className="w-full h-screen bg-white flex">
                <div className="relative w-[50%] h-screen flex items-center pl-[10%]">
                    <div className="
                        relative w-[45vh] h-[45vh] rounded-[50%] bg-white overflow-hidden
