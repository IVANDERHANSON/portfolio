    ...
    return (
        <>
            <nav className="top-0 left-0 right-0 z-[9999] fixed">
                <div className="relative left-[5%] w-[90%] top-[1rem] h-[4.55rem] bg-white flex justify-evenly items-center border-[0.05rem] border-solid border-black border-opacity-[0.5] shadow-[0.01rem_0.01rem_0.31rem] shadow-black rounded-full">
                    <a href="#home"
